...
//  '<S48>'  : 'arduAttCont/pitch rate PID Controller/Tsamp - Integral/TsSignalSpecification'
...
//  '<S96>'  : 'arduAttCont/roll rate PID Controller/Tsamp - Integral/TsSignalSpecification'
...
//  '<S144>' : 'arduAttCont/yaw rate PID Controller/Tsamp - Integral/TsSignalSpecification'
